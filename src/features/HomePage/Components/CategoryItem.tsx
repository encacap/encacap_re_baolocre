...
const CategoryItem = ({ href, image, name }: CategoryItemProps) => {
  return (
    <Link href={href}>
      <a
        className="flex flex-col items-center w-full py-8 duration-200 border-2 border-transparent rounded-lg md:justify-center md:px-10 md:border-gray-100 hover:shadow-lg hover:text-encacap-main hover:border-encacap-main"
        href="/"
      >
