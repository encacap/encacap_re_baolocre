...
import { Children, ReactElement, ReactNode, cloneElement, useEffect, useRef } from "react";
...
function NavbarContainer({ className, children: sidebarItems }: SidebarContainerProps) {
