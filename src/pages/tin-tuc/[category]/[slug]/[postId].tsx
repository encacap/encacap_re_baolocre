...
const Home = (props: NewsDetailPageProps) => <NewsDetailPage {...props} />;

export const getServerSideProps = () => {
    const head = { title: "Lâm Đồng cho phép lập quy hoạch dự án Quần thể vui chơi giải trí làng Châu Âu 18.000 ha" };
